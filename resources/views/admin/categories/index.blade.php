...
@section('page_title','قائمة التصنيفات');
        ...
        <table class="table table-hover table-bordered text-center " id="datatable">
            ...
            @foreach($categories as $category)
                <tr class="">
                    ...
                    <td>{{$category->name}}</td>
                    <td>
                        {{ \Illuminate\Support\Str::limit($category->desc, 50, $end='...') }}
                    </td>
                    <td>
                        <a href="{{route('category.edit',$category->id)}}" class="btn btn-primary btn-sm">تعديل</a>
                    </td>
